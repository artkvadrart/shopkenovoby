...
const CardImageUpload = (
  ...
  return (
    ...
    <div className="p-2 m-2 bg-white flex flex-row border rounded-sm shadow-lg">
      ...
      <div className="ml-8 mr-4 my-4 place-content-start" ><Button onClick={onDelete} type="button" variant="outline" size="icon" className="size-10"><X /></Button></div>      
      
    </div>


    
    {/* <div className="p-2 m-2 flex flex-row border rounded-sm shadow-sm">
      <div className="ml-4 my-4" >  
        <Button variant="secondary" size="icon" className="size-10"><ChevronUpIcon /></Button>
        <Button variant="secondary" size="icon" className="size-10"><ChevronDownIcon /></Button>
      </div>
      <div className="mx-2 my-4" >CardImageUpload</div>
      <div className="mx-2 my-4" >CardImageUpload</div>
      <div className="mr-4 my-4" ><Button variant="secondary" size="icon" className="size-10"><Trash2 /></Button></div>      
    </div> */}
