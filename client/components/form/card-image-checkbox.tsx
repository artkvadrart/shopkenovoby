...
const CardImageCheckbox = (
  ...
  //   const checked = selectedImageProps?.ulid
  //     return checked
          ...
          <div className="p-0 m-2 bg-white flex flex-col border border-gray-400/50 rounded-xs shadow-lg">
            <div className="flex relative justify-center p-0">
              ...
              <Checkbox 
                ...
                // checked={false}
                id={nameProps}
                defaultChecked={selectedImageProps?.some((selectedImage) => selectedImage.ulid === nameProps)}      //!!selectedImageProps?.ulid} // selectedImageProps.some((selectedImage) => selectedImage.ulid === nameProps)
                name={nameProps} 
                value={nameProps} 
                type="button" 
