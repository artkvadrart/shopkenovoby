...
import { TextNode, type EditorThemeClasses, type LexicalEditor, type SerializedEditorState, type SerializedLexicalNode } from 'lexical';
...
export default function Editor(
  ...
  editor.registerUpdateListener(({editorState}) => {
    ...
    const fromEditorJson: iFromEditorJson = { lng: languageCodeProps, json: jsonString }
    console.log('fromEditorJson', languageCodeProps, fromEditorJson);
    console.log('fromEditorJsonProps', languageCodeProps, fromEditorJsonProps);


    if (!fromEditorJsonProps) 
      {setFromEditorJsonProps([fromEditorJson]);
    }
    else {  
      const index = fromEditorJsonProps?.findIndex(item => item.lng === fromEditorJson.lng);
