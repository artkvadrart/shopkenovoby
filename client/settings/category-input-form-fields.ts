...
export const categoryInputFormFieldsDescriptionJson : IcategoryInputFormFields  = {
  ru :  [
    ...
    {namefield : "name", labelfield : "имя категории", placeholderfield : "имя категории", descriptionfiled : "введите введите уникальное имя категории", defaultfield : "",  zod : z.string().min(5), typefield : "input"},
  ...
  en :  [
    ...
    {namefield : "name", labelfield : "name of category", placeholderfield : "name of category", descriptionfiled : "введите введите уникальное имя категории", defaultfield : "",  zod : z.string().min(5), typefield : "input"},
    {namefield : "description", labelfield : "описание категории", placeholderfield : "краткое описание категории", descriptionfiled : "введите краткое описание, 200 символов", defaultfield : "",  zod : z.string().min(5), typefield : "input"},
    {namefield : "descriptionextendet", labelfield : "расширенное описание категории", placeholderfield : "расширенное описание категории", descriptionfiled : "введите расширенное описание", defaultfield : "",  zod : z.string().min(5), typefield : "textarea"},
  ] 
  ,
...
export const categoryInputFormFieldsNoTranslateData : IcategoryInputFormFields = {
  ru : [
    {namefield : "parentid", labelfield : "родительская категория", placeholderfield : "родительская категория", descriptionfiled : "введите родительскую категорию", defaultfield : 0,  zod : z.string().min(5), typefield : "input"},
    {namefield : "path", labelfield : "последовательность вложенных категорий", placeholderfield : "последовательность вложенных категорий", descriptionfiled : "последовательность вложенных категорий", defaultfield : "",  zod : z.string().min(5), typefield : "input"},
    {namefield : "top", labelfield : "показывать в меню", placeholderfield : "показывать в меню", descriptionfiled : "отметьте если необходимо показать категорию в меню", defaultfield : false,  zod : z.string().min(5), typefield : "checkbox"},
    ...
    {namefield : "furl", labelfield : "seo имя категории", placeholderfield : "seo имя категории", descriptionfiled : "введите seo имя категории (пример: /hook)", defaultfield : "",  zod : z.string().min(5), typefield : "input"},
...
export const categoryInputFormFieldsSeoJson : IcategoryInputFormFields = {
  ru : [
    ...
    {namefield :"title", labelfield : "title", placeholderfield : "title", descriptionfiled : "введите title", defaultfield : 0,  zod : z.string().min(5), typefield : "input"},
