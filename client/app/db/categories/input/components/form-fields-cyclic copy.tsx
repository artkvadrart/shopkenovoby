...
import CategoryZodDefaultFormfield from './category-zod-default-formfield'
...
export default function FormFieldsCyclic({
   ...
   arrayNameFormFieldNoTranslateData
    ...
    formSchemaProps: z.AnyZodObject;
    formDefaultValues: INameFieldForm;
    arrayNameFormFieldDescriptionJson: Array<iArrayNameFormField>; 
    arrayNameFormFieldSeoJson: Array<iArrayNameFormField>; 
    arrayNameFormFieldNameSetParametrsJson: Array<iArrayNameFormField>; 
    arrayNameFormFieldNoTranslateData: Array<iArrayNameFormField>;
      } )   {
...
//***************************
  ...
  // console.log(...arrayNameFormFieldDescriptionJson);
...
//   ...nameFieldForm,
//   // email: z.string().min(5, { message: "Ай нанэ" } ),
// });
...
// };
  ...
  // function FormReactHooksTypefieldsDescription( {formControlProps, arrayNameFormFieldDescriptionJson} : 
  //   {formControlProps: any; arrayNameFormFieldDescriptionJson: iArrayNameFormField[] } ) {
