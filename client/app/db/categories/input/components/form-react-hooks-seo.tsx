...
import { divide } from "lodash";
  function FormReactHooksSeo({
    formControlProps,
    arrayNameFormFieldSeoJsonProps,
    formProps,
   ...
   //  idParent: number; for delete
    ...
    arrayNameFormFieldSeoJsonProps.sort((a, b) =>
    ...
    arrayNameFormFieldSeoJsonProps.map((description) => {
    ...
    arrayNameFormFieldSeoJsonProps.map((element, index) => {
      arrayJSX.push(
        <FormField
...
export default FormReactHooksSeo