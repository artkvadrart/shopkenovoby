        ...
        <TableContext>
          <ToolbarContext>            
            <div className="editor-shell">
              <Editor setFromEditorProps={setFromEditorProps} setFromEditorJsonProps={setFromEditorJsonProps} updateStateProps={updateStateProps}/>
            </div>
            <Settings />
...
// {convertLexicalToHtmlProps}: {convertLexicalToHtmlProps:(editor: LexicalEditor) => string}
  ...
  return (
    <SettingsContext>
      <FlashMessageContext>
        <App setFromEditorProps={setFromEditorProps} setFromEditorJsonProps={setFromEditorJsonProps} updateStateProps={updateStateProps}/>
      </FlashMessageContext>     
    </SettingsContext>
  );
}
