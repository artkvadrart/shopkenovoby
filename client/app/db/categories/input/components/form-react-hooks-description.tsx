...
import GetTypeField from '@/app/db/categories/input/components/get-type-field'
  ...
  function FormReactHooksDescription({
    formControlProps,
    arrayNameFormFieldDescriptionJsonProps,
    formProps,
    ...
    arrayNameFormFieldDescriptionJsonProps: Array<iArrayNameFormField>;
   ...
   //  idParent: number; for delete
    ...
    arrayNameFormFieldDescriptionJsonProps.sort((a, b) =>
    ...
    arrayNameFormFieldDescriptionJsonProps.map((description) => {
    ...
    arrayNameFormFieldDescriptionJsonProps.map((element, index) => {
      arrayJSX.push(
        <FormField
  ...
  export default  FormReactHooksDescription 