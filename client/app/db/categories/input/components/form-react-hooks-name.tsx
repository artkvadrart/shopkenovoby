...
function FormReactHooksName({
    formControlProps,
    arrayNameFormFieldNameJsonProps,
    formProps,
    ...
    arrayNameFormFieldNameJsonProps: Array<iArrayNameFormField>;
   ...
   //  idParent: number; for delete
    ...
    arrayNameFormFieldNameJsonProps.sort((a, b) =>
    ...
    arrayNameFormFieldNameJsonProps.map((description) => {
    ...
    arrayNameFormFieldNameJsonProps.map((element, index) => {
      arrayJSX.push(
        <FormField
  ...
  export default FormReactHooksName