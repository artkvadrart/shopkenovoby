...
interface iFormFieldsCyclicProps {
...
const FormFieldsCyclic : React.FC<iFormFieldsCyclicProps> = function  (
  ...
  // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  function FormReactHooksTypefieldsName({
    formControlProps,
  }: {
    ...
    arrayNameFormFieldNameJson.sort((a, b) =>
    ...
    arrayNameFormFieldNameJson.map((description) => {
      ...
      if (variableNow != variablePrev && i < activeLanguages.length) {
        ...
        description.classhtml =
          "border-b-2 border-x-2 border-red-300 rounded-b-sm p-4 mb-4";
        i = 1;
      }
    });

    arrayNameFormFieldNameJson.map((element, index) => {
      arrayJSX.push(
        <FormField
            ...
            <FormItem className={element.classhtml}>
              ...
              <FormControl>
                <GetTypeField
                  ...
                  pathsCategories = {pathsCategories}
  ...
  // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  function FormReactHooksTypefieldsDescription({
    formControlProps,
  }: {
    formControlProps: any;
  }) {
    ...
    arrayNameFormFieldDescriptionJson.sort((a, b) =>
      a.namefieldlangsort > b.namefieldlangsort ? 1 : -1
    );
  ...
  // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  function FormReactHooksTypefieldsSeo({
    formControlProps,
  }: {
    formControlProps: any;
  }) {
    ...
    arrayNameFormFieldSeoJson.sort((a, b) =>
      a.namefieldlangsort > b.namefieldlangsort ? 1 : -1
    );
  ...
  // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  function FormReactHooksTypefieldsNameSetParametrs({
    formControlProps,
  }: {
    formControlProps: any;
  }) {
    ...
    arrayNameFormFieldNameSetParametrsJson.sort((a, b) =>
      a.namefieldlangsort > b.namefieldlangsort ? 1 : -1
    );
  ...
  // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  function FormReactHooksTypefieldsNoTranslateData({
    formControlProps,
  }: {
    formControlProps: any;
  }) {
  ...
  return (
    <div>
      ...
      <Form {...form}>
        ...
        >          
          {FormReactHooksTypefieldsName({ formControlProps: form.control })}
          ...
          ***********************************************
          ...
          <Button
            type='submit'
            variant={"default"}
            className='w-80 text-3xl md:text-3xl'
            size={"lg"}
          >
            #Впирод
          </Button>
